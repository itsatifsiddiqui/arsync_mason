...
extension VxPaddingExtensions on Widget {
  ...
  Padding p0({Key? key}) =>
      Padding(key: key, padding: const EdgeInsets.all(0), child: this);

  /// Gives 1dp padding from all sides.
  Padding p1({Key? key}) =>
      Padding(key: key, padding: const EdgeInsets.all(1), child: this);

  /// Gives 2dp padding from all sides.
  Padding p2({Key? key}) =>
      Padding(key: key, padding: const EdgeInsets.all(2), child: this);

  /// Gives 4dp padding from all sides.
  Padding p4({Key? key}) =>
      Padding(key: key, padding: const EdgeInsets.all(4), child: this);

  /// Gives 8dp padding from all sides.
  Padding p8({Key? key}) =>
      Padding(key: key, padding: const EdgeInsets.all(8), child: this);

  /// Gives 12dp padding from all sides.
  Padding p12({Key? key}) =>
      Padding(key: key, padding: const EdgeInsets.all(12), child: this);
  ...
  Padding p20({Key? key}) =>
      Padding(key: key, padding: const EdgeInsets.all(20), child: this);

  /// Gives 24dp padding from all sides.
  Padding p24({Key? key}) =>
      Padding(key: key, padding: const EdgeInsets.all(24), child: this);

  /// Gives 32dp padding from all sides.
  Padding p32({Key? key}) =>
      Padding(key: key, padding: const EdgeInsets.all(32), child: this);

  /// Gives 64dp padding from all sides.
  Padding p64({Key? key}) =>
      Padding(key: key, padding: const EdgeInsets.all(64), child: this);
